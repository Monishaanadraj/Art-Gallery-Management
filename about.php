            ...
            <div class="about-sub-inner text-center mt-lg-4 mt-3">
               ...
               <div class="row">
                  <div class="col-lg-6 col-md-6 abut-gride">
                     ...
                     <h5>Shipping</h5>
                     <p class="mt-3">Experience seamless and reliable shipping, ensuring every masterpiece reaches you safely and on time.
                     </p>
                  </div>
                  <div class="col-lg-6 col-md-6 abut-gride">
                     <span class="fas fa-phone-volume"></span>  
                     <h5>Support</h5>
                     <p class="mt-3"> We're here to assist you every step of the way, ensuring a smooth and enjoyable experience with our gallery.
                     </p>
                  </div>
                  <!-- <div class="col-lg-4 col-md-4 abut-gride">
                     <span class="fas fa-undo"></span>
                     <h5> Return</h5>
                     <p class="mt-3">Our hassle-free return policy ensures your satisfaction, making it easy to shop with confidence.
                     </p>
                  </div> -->
               </div>
            </div>
