...
?>
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="info-box brown-bg">
              <?php $query1=mysqli_query($con,"Select * from tblartcustomizations");
$apcount=mysqli_num_rows($query1);
?>
              <i class="fa fa-file"></i>
              <div class="count"><?php echo $apcount;?></div>
              <div class="title"> <a class="dropdown-item" href="customized-art.php">Customized Art</a></div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="info-box dark-bg">
              <?php $query2=mysqli_query($con,"Select * from orders");
$apcount=mysqli_num_rows($query2);
?>
              <i class="fa fa-file"></i>
              <div class="count"><?php echo $apcount;?></div>
             <div class="title"> <a class="dropdown-item" href="manage-order.php">Total Orders</a></div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
...
?>
              <i class="fa fa-file"></i>
              <div class="count"><?php echo $apcount;?></div>
             <div class="title"> <a class="dropdown-item" href="customized-order.php">Customized Arts Orders</a></div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
