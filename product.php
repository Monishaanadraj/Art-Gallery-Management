                                    ...
                                    <div class="grid_meta">
                                       <div class="product_price">
                                          ...
                                          <div class="d-flex">
                                             ...
                                             <a class="btn btn-success" style="margin-left: 10px;" href="single-product.php?pid=<?php echo $row['apid'];?>">Buy</a>
                                             <a class="btn btn-success" style="margin-left: 10px;" href="single-product.php?pid=<?php echo $row['apid'];?>">Customize</a>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
