      ...
      <section class="banner-bottom py-lg-5 py-3">
         <div class="container">
            <div class="inner-sec-shop pt-lg-4 pt-3">
               <?php
               $pid=$_GET['pid'];
$ret=mysqli_query($con,"select tblarttype.ID as atid,tblarttype.ArtType as typename,tblartmedium.ID as amid,tblartmedium.ArtMedium as amname,tblartproduct.ID as apid,tblartproduct.SellingPricing as sprice,tblartist.Name,tblartproduct.Title,tblartproduct.Dimension,tblartproduct.Orientation,tblartproduct.Size,tblartproduct.Artist,tblartproduct.ArtType,tblartproduct.ArtMedium,tblartproduct.SellingPricing,tblartproduct.Description,tblartproduct.Image,tblartproduct.Image1,tblartproduct.Image2,tblartproduct.Image3,tblartproduct.Image4,tblartproduct.RefNum,tblartproduct.ArtType from tblartproduct join tblarttype on tblarttype.ID=tblartproduct.ArtType join tblartmedium on tblartmedium.ID=tblartproduct.ArtMedium join tblartist on tblartist.ID=tblartproduct.Artist where tblartproduct.ID='$pid'");
$cnt=1;
...
?>
            ...
            <?php endif;?>
                  ...
                  <div class="col-lg-8 single-right-left simpleCart_shelfItem">
                     ...
                     <div class="color-quality">
                        <div class="color-quality-right">
                           <h5>Price : <?php echo $row['sprice'];?></h5>
                        </div>
                     </div>
                     <div class="occasion-cart">
    <div class="d-flex margin-100px">
        <button class="btn btn-success me-2">
            <a href="art-enquiry.php?eid=<?php echo $row['apid'];?>" style="color: #fff;">Enquiry</a>
        </button>
        <button class="btn btn-success" style="margin-left: 10px;"> <!-- Added margin-left -->
            <a href="cart.php?action=add&pid=<?php echo $row['apid'];?>" style="color:#fff">Add to Cart</a>
        </button>
            <a class="btn btn-success" style="margin-left: 10px;" href="customize.php?pid=<?php echo $row['apid'];?>">Customize</a>
            <!-- <a class="btn btn-success" style="margin-left: 10px;" href="view-customize.php?pid=<?php echo $row['apid'];?>">View Customized Art</a> -->
    </div>
</div>
